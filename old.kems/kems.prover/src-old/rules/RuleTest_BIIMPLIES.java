...
public class RuleTest_BIIMPLIES extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        KERules.put(RuleCode.T_BIIMPLIES_LEFT_TRUE,
                ClassicalRules.T_BIIMPLIES_LEFT_TRUE);
        KERules.put(RuleCode.F_BIIMPLIES_LEFT_TRUE,
                ClassicalRules.F_BIIMPLIES_LEFT_TRUE);
        KERules.put(RuleCode.T_BIIMPLIES_LEFT_FALSE,
                ClassicalRules.T_BIIMPLIES_LEFT_FALSE);
        KERules.put(RuleCode.F_BIIMPLIES_LEFT_FALSE,
                ClassicalRules.F_BIIMPLIES_LEFT_FALSE);
        KERules.put(RuleCode.X_BIIMPLIES_T_LEFT,
                ClassicalRules.X_BIIMPLIES_T_LEFT);
        KERules.put(RuleCode.X_BIIMPLIES_T_RIGHT,
                ClassicalRules.X_BIIMPLIES_T_RIGHT);
        KERules.put(RuleCode.X_BIIMPLIES_F_LEFT,
                ClassicalRules.X_BIIMPLIES_F_LEFT);
        KERules.put(RuleCode.X_BIIMPLIES_F_RIGHT,
    ...
    public void test_F_BIIMPLIES_LEFT_TRUE() {
        Rule r1 = KERules.get(RuleCode.F_BIIMPLIES_LEFT_TRUE);
    ...
    public void test_T_BIIMPLIES_LEFT_TRUE() {
        Rule r1 = KERules.get(RuleCode.T_BIIMPLIES_LEFT_TRUE);
    ...
    public void test_F_BIIMPLIES_LEFT_FALSE() {
        Rule r1 = KERules.get(RuleCode.F_BIIMPLIES_LEFT_FALSE);
    ...
    public void test_T_BIIMPLIES_LEFT_FALSE() {
        Rule r1 = KERules.get(RuleCode.T_BIIMPLIES_LEFT_FALSE);
    ...
    private void aux_test_X_BIIMPLIES_T_LEFT(SignedFormula sfMain,
        ...
        Rule r1 = KERules.get(RuleCode.X_BIIMPLIES_T_LEFT);
    ...
    private void aux_test_X_BIIMPLIES_T_RIGHT(SignedFormula sfMain,
            SignedFormula result) {
        Rule r1 = KERules.get(RuleCode.X_BIIMPLIES_T_RIGHT);
    ...
    private void aux_test_X_BIIMPLIES_F_LEFT(SignedFormula sfMain,
            SignedFormula result) {
        Rule r1 = KERules.get(RuleCode.X_BIIMPLIES_F_LEFT);
    ...
    private void aux_test_X_BIIMPLIES_F_RIGHT(SignedFormula sfMain,
            SignedFormula result) {
        Rule r1 = KERules.get(RuleCode.X_BIIMPLIES_F_RIGHT);
